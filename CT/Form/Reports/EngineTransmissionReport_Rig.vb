...
Namespace Form.Reports
    ...
    Public Class EngineTransmissionReport_Rig
        ...
        Public Sub EngineTransmissionReport(HCID As Integer, Region As String)
            Try
                ...
                Dim _plan As CT.Data.RigPlan.Plan = New CT.Data.RigPlan.Plan()
                ...
                rst = _plan.GetCTEnginesAndTransmissions(HCID, Form.DataCenter.ProgramConfig.BuildType)

                If rst.Rows.Count = 0 Then
                    MsgBox("No data to display!", MsgBoxStyle.OkOnly, "Engine Transmission Report")
                    Exit Try
                End If
                ...
                For i = 0 To Engine.Count - 1
                    ...
                    For j = 0 To rst.Rows.Count - 1
                        ...
                        If rst.Rows(j)(key).ToString() = "" Then
                            rst.Rows(j)(key) = 0
                        End If
                        If rst.Rows(j)("BuildTypes") = "Vehicle" Then
                            objEngine.intVehicles = rst.Rows(j)(key)
                        ElseIf rst.Rows(j)("BuildTypes") = "Buck" Then
                            objEngine.intBucks = rst.Rows(j)(key)
                        ElseIf rst.Rows(j)("BuildTypes") = "Rig" Then
                            objEngine.intRigs = rst.Rows(j)(key)
                        ElseIf rst.Rows(j)("BuildTypes") = "Rebuild" Then
                ...
                'rst = _plan.GetXCCEnginesAndTransmissions(HCID)
                'For Each row As DataRow In rst.Rows
                '    For Each colmn As DataColumn In rst.Columns
                '        If bolEngineStarted Then
                '            If Not colmn.ColumnName = "EngineEnd - TransStart" Then
                ...
                shp.TextFrame2.TextRange.Characters.Text = "Engine and Transmission CT DB report" & vbLf & strTempTitle(0) & vbLf & strTempTitle(1) & vbLf & strTempTitle(2)
