...
Public Class frmNewVehicle_Rig
    Private Sub frmNewRig_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmNewRig_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub frmNewRig_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAddUnit_Click(sender As Object, e As EventArgs) Handles btnAddUnit.Click
        ...
        Try
            ...
            Dim _Unit As CT.Data.RigPlan.Unit = New Data.RigPlan.Unit
