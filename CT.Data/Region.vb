...
Public Class Region
    ...
    ''' <summary>
    ''' The columns in output are pe27_Regions_PK, Regions
    ''' </summary>
    ''' <returns></returns>
    Public Function SelectAll() As DataTable
        ...
        Try
            ...
            Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                ...
                Dim command As SqlCommand = New SqlCommand(DataCenter.StoredProcedures.General.StandardCatalog_RegionsSelectById.ToString())
                command.Connection = conTnd
                command.CommandType = CommandType.StoredProcedure
                command.Parameters.Add("@pe27_Regions_ID", SqlDbType.Int, 4).Value = DBNull.Value
