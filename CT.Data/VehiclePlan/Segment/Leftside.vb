...
Namespace VehiclePlan.Segment
    Public Class Leftside
        ...
        Implements CT.Data.Interfaces.LeftInterface


        Public Function GetPlanDataHcIdSpecific(HcId As Integer, UpperBoundDisplaySeq As Object, LowerBoundDisplaySeq As Object, MainBuildType As String) As String(,) Implements Interfaces.LeftInterface.GetPlanDataHcIdSpecific
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    command = New SqlCommand(DataCenter.StoredProcedures.VehiclePlan.A2_VehicleAnd7Tabs_Vehicle_Specific.ToString())
        ...
        Public Function GetPlanDataHcIdGeneric(HcId As Integer, MainBuildType As String, UpperBoundDisplaySeq As Object, LowerBoundDisplaySeq As Object) As String(,) Implements Interfaces.LeftInterface.GetPlanDataHcIdGeneric
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Dim command As SqlCommand = Nothing
                    command = New SqlCommand(DataCenter.StoredProcedures.VehiclePlan.A2_VehicleAnd7Tabs_Vehicle_Generic.ToString())
                    command.Connection = conTnd
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 20).Value = MainBuildType
                    command.Parameters.Add("@HealthChartId", SqlDbType.Int, 4).Value = HcId
