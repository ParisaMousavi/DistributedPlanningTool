    ...
    Public Class Unit
        ...
        Public Function ChangeInfoII(Pe02 As Long, pe45 As Long, Pe03 As Long, MainBuildType As String, FileStatus As String, HealthChartId As Long, Optional StrCBG As Object = Nothing,
            ...
            Try
                ...
                If CustomerRequiredDate IsNot Nothing Then Throw New Exception("The CustomerRequiredDate value must ne always nothing in vehicle Plans.")
                If RigCustomerPickDate IsNot Nothing Then Throw New Exception("The CustomerRequiredDate value must ne always nothing in vehicle Plans.")
