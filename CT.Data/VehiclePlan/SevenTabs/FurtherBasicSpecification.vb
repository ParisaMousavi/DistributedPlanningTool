...
Namespace VehiclePlan.SevenTabs
    Public Class FurtherBasicSpecification
        ...
        Implements Interfaces.FurtherBasicInterface


        Public Function GetPlanData(pe02 As Long, UpperBoundDisplaySeq As Object, LowerBoundDisplaySeq As Object, MainBuildType As String) As String(,) Implements FurtherBasicInterface.GetPlanData
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    command = New SqlCommand(DataCenter.StoredProcedures.VehiclePlan.A2_VehicleAnd7Tabs_Vehicle_Specific_FurtherBasicPartial.ToString())
        ...
        Public Function GetTndPlanHeader(HCID As Integer, BuildType As String, BuildPhase As String, MainBuildType As String) As String(,) Implements FurtherBasicInterface.GetTndPlanHeader

            Try

                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    Dim command As SqlCommand = Nothing
                    command = New SqlCommand(DataCenter.StoredProcedures.VehiclePlan.A1_Header_Vehicle_Specific_FurtherBasicPartial.ToString())
                    command.Connection = conTnd
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 20).Value = MainBuildType
