...
Namespace VehiclePlan.SevenTabs
    Public Class Instrumentation
        ...
        Implements CT.Data.Interfaces.InstrumentationInterface

        Public Function GetPlanData(pe02 As Long, UpperBoundDisplaySeq As Object, LowerBoundDisplaySeq As Object, MainBuildType As String) As String(,) Implements Interfaces.InstrumentationInterface.GetPlanData
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    command = New SqlCommand(DataCenter.StoredProcedures.VehiclePlan.A2_VehicleAnd7Tabs_Vehicle_Specific_InstrumentationPartial.ToString())
        ...
        Public Function GetTndPlanHeader(HCID As Integer, BuildType As String, BuildPhase As String, MainBuildType As String) As String(,) Implements Interfaces.InstrumentationInterface.GetTndPlanHeader
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Dim command As SqlCommand = Nothing
                    command = New SqlCommand(DataCenter.StoredProcedures.VehiclePlan.A1_Header_Vehicle_Specific_InstrumentationPartial.ToString())
                    command.Connection = conTnd
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 20).Value = MainBuildType
