...
Namespace RigPlan.SevenTabs
    Public Class FurtherBasicSpecification
        ...
        Implements CT.Data.Interfaces.FurtherBasicInterface

        Public Function GetPlanData(pe02 As Long, UpperBoundDisplaySeq As Object, LowerBoundDisplaySeq As Object, MainBuildType As String) As String(,) Implements Interfaces.FurtherBasicInterface.GetPlanData
        ...
        Public Function GetTndPlanHeader(HCID As Integer, BuildType As String, BuildPhase As String, MainBuildType As String) As String(,) Implements Interfaces.FurtherBasicInterface.GetTndPlanHeader
