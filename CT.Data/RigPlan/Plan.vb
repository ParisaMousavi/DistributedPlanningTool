...
Imports CT.Data.VehiclePlan

Namespace RigPlan

    Public Class Plan
        Inherits CtBaseClass
        Implements Data.Interfaces.PlanInterface
        ...
        Public Function SelectAllSpecificTndPlans() As DataTable Implements Interfaces.PlanInterface.SelectAllSpecificTndPlans
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Dim command As SqlCommand = New SqlCommand(DataCenter.StoredProcedures.RigPlan.Code_Rig_AllSpecificTnDPlanListVers115.ToString())
        ...
        Public Function SelectAllGenericTndPlan() As DataTable Implements Interfaces.PlanInterface.SelectAllGenericTndPlan
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Dim command As SqlCommand = New SqlCommand(DataCenter.StoredProcedures.RigPlan.Code_Rig_AllGenericTnDPlanListVers115.ToString())
                    command.Connection = conTnd
                    command.CommandType = CommandType.StoredProcedure
        ...
        Public Function ValidatePlan(HealChartId As Integer, MainBuildType As String, FileStatus As String) As DataTable Implements Interfaces.PlanInterface.ValidatePlan
            ...
            Try
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    Dim command As SqlCommand = New SqlCommand(DataCenter.StoredProcedures.RigPlan.Validation_RigOverallValidation.ToString())
                    command.Connection = conTnd
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.Add("@HealthChartId", SqlDbType.Int, 4).Value = HealChartId
                    command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 10).Value = MainBuildType 'CT.Data.DataCenter.BuildType.Rig.ToString
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Try
                        ...
                        If FileStatus = DataCenter.FileStatus.Draft Then
                            ...
                            'Code_AllTnDDraftPlanL
                            command = New SqlCommand(DataCenter.StoredProcedures.RigPlan.Code_Rig_AllTnDDraftPlanList.ToString())
                            command.Connection = conTnd
                            command.Transaction = transaction
                            command.CommandType = CommandType.StoredProcedure
                            command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 20).Value = MainBuildType
        ...
        Public Function SelectAllTndDraftPlans(MainBuildType As String, HCID As Integer) As DataTable Implements Interfaces.PlanInterface.SelectAllTndDraftPlans
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Dim command As SqlCommand = New SqlCommand(DataCenter.StoredProcedures.RigPlan.Code_Rig_AllTnDDraftPlanList.ToString())
                    command.Connection = conTnd
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 20).Value = MainBuildType
                    command.Parameters.Add("@MainPlanHCID", SqlDbType.Int, 4).Value = HCID
        ...
        Public Function GetQuantityTableXCC(HCID As Integer, MainBuildType As String) As DataTable Implements Interfaces.PlanInterface.GetQuantityTableXCC
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Dim command As SqlCommand = New SqlCommand(DataCenter.StoredProcedures.RigPlan.Report_Rig_QuantityTableXCC.ToString())
                    command.Connection = conTnd
                    command.CommandType = CommandType.StoredProcedure
        ...
        Public Function GetQuantityTableCT(HCID As Integer, MainBuildType As String) As DataTable Implements Interfaces.PlanInterface.GetQuantityTableCT
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Dim command As SqlCommand = New SqlCommand(DataCenter.StoredProcedures.RigPlan.Report_Rig_QuantityTableCT.ToString())
                    command.Connection = conTnd
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 20).Value = MainBuildType
                    command.Parameters.Add("@HCID", SqlDbType.Int, 4).Value = HCID
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Try
                        ...
                        ' Step 2
                        '-------------------------------------------------
                        command = New SqlCommand(DataCenter.StoredProcedures.RigPlan.LoadingRig1_Generic_AddXccSingleProgram.ToString())
                        command.Connection = conTnd
                        command.Transaction = transaction
                        command.CommandType = CommandType.StoredProcedure
                        ...
                        ' Step 3
                        '-------------------------------------------------
                        command = New SqlCommand(DataCenter.StoredProcedures.RigPlan.LoadingRig2_Generic_AddTnDPlanner.ToString())
                        command.Connection = conTnd
                        command.Transaction = transaction
                        command.CommandType = CommandType.StoredProcedure
                        command.Parameters.Add("@pe01_ProgramUniqueId", SqlDbType.Int, 4).Value = xccpe01
                        ...
                        ' Step 4
                        '-------------------------------------------------
                        command = New SqlCommand(DataCenter.StoredProcedures.RigPlan.LoadingRig3_Generic_GenericSplit.ToString())
                        command.Connection = conTnd
                        command.Transaction = transaction
                        command.CommandType = CommandType.StoredProcedure
                        command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 20).Value = BuildType
                        ...
                        ' Step 5
                        '-------------------------------------------------
                        command = New SqlCommand(DataCenter.StoredProcedures.RigPlan.LoadingRig4_Generic_PowerPackAllocation.ToString())
                        command.Connection = conTnd
                        command.Transaction = transaction
                        command.CommandType = CommandType.StoredProcedure
                        command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 20).Value = BuildType
                        ...
                        ' Step 6
                        '-------------------------------------------------
                        command = New SqlCommand(DataCenter.StoredProcedures.RigPlan.LoadingRig5_Generic_UsercaseAllocationLogicII.ToString())
                        command.Connection = conTnd
                        command.Transaction = transaction
                        command.CommandType = CommandType.StoredProcedure
                        ...
                        ' Step 7
                        '-------------------------------------------------
                        command = New SqlCommand(DataCenter.StoredProcedures.RigPlan.LoadingRig8_Generic_InitialPrototypeTeamnameAssaignment.ToString())
                        command.Connection = conTnd
                        command.Transaction = transaction
                        command.CommandType = CommandType.StoredProcedure
                        command.Parameters.Add("@pe01_TnDBasicProgram_PK", SqlDbType.BigInt, 8).Value = pe01
        ...
        Public Function SelectTndDraftPlanDedicated(DraftHCID As Integer, MainBuildType As String) As DataTable Implements Interfaces.PlanInterface.SelectTndDraftPlanDedicated
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Dim command As SqlCommand = New SqlCommand(DataCenter.StoredProcedures.RigPlan.Code_Rig_TnDDraftPlanDedicated.ToString())
                    command.Connection = conTnd
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 20).Value = MainBuildType
            ...
            Try
                ...
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Try
                        ...
                        '
                        '-------------------------------------------------
                        command = New SqlCommand(DataCenter.StoredProcedures.RigPlan.LoadingRig7_Specific_AllocatedUsercasesGenericToSpecificII.ToString())
                        command.Connection = conTnd
                        command.Transaction = transaction
                        command.CommandType = CommandType.StoredProcedure
                        command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 20).Value = BuildType
        ...
        Public Function Validaion_1(XCCpe01 As Long, HCID As Integer, BuildPhase As String, BuildType As String) As Boolean
            ...
            Try
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Dim command As SqlCommand = New SqlCommand(DataCenter.StoredProcedures.RigPlan.Generic_Check_Rig_1_InsertToPe01.ToString())
                    command.Connection = conTnd
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.Add("@pe01_programUniqueId", SqlDbType.BigInt, 8).Value = XCCpe01
                    command.Parameters.Add("@MainBuildType", SqlDbType.NVarChar, 20).Value = CT.Data.DataCenter.BuildType.Rig.ToString
                    command.Parameters.Add("@HealthChartId", SqlDbType.Int, 4).Value = HCID
                    command.Parameters.Add("@BuildPhase", SqlDbType.NVarChar, 10).Value = BuildPhase
        ...
        Public Function Validaion_2(XCCpe01 As Long, XCCpe26 As Long, HCID As Integer, BuildPhase As String, BuildType As String) As Boolean
            ...
            Try
                Using conTnd As SqlConnection = New SqlConnection(CT.Data.My.Settings.ConnectionString1)
                    ...
                    Dim command As SqlCommand = New SqlCommand(DataCenter.StoredProcedures.RigPlan.Generic_Check_Rig_2_InsertToPe02.ToString())
                    command.Connection = conTnd
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.Add("@pe01_programUniqueId", SqlDbType.BigInt, 8).Value = XCCpe01
                    command.Parameters.Add("@pe26_ProgramBaseInfoUniqueId", SqlDbType.BigInt, 8).Value = XCCpe26
